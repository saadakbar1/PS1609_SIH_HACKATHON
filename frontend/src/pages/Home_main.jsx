  ...
  return (
    <div className="min-h-screen">
      <div className="h-80 sm:h-96 xl:h-[500px] 2xl:h-[600px] p-0.5">
        <Carousel>
          <img src="https://media.istockphoto.com/id/1151567114/photo/a-young-female-graduate-against-the-background-of-university-graduates.jpg?s=612x612&w=0&k=20&c=zAFyR9UEbOWLOXqdNQSItVxVxOrjhOvwkfms-TyigA4=" alt="..." className='object-cover'/>
          <img src="https://media.istockphoto.com/id/962224288/photo/confident-young-businesswoman-talking-on-mobile.jpg?s=612x612&w=0&k=20&c=p9wVUR9ii8M6fQISX-WUWxNn83AKw9l6ctVpoKDLYJg=" alt="..." className='object-cover' />
          <img src="https://media.istockphoto.com/id/1359662582/photo/group-of-happy-college-student-stock-photo.jpg?s=612x612&w=0&k=20&c=Oq4d6V5XJi9LayES7cH6n2obZWqVuzJOq2CtSBSiP6g=" alt="..." className='object-cover' />
